...
const Header: FunctionComponent = () => {
  ...
  return (
    <>
      ...
      <div className='bg-white h-12 w-12 flex items-center justify-center lg:hidden fixed bottom-5 right-5 sm:bottom-10 sm:right-10 z-10 shadow-md rounded-md cursor-pointer'>
